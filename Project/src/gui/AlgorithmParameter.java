...
/**
 * This class provides a generic representation for the input parameters of
 * BioinfAlgorithm. It is used to build up a GUI for user inputs and to run the
 * algorithm
 * 
...
public class AlgorithmParameter {
  ...
  /**
   * The class of the Parameter. (Currently all Number derived classes and
   * String supported.)
   */
   ...
   * @param type_
   *          the type of the parameter (String or Number derived classes)
   */
